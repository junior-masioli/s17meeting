...
class MeetingSurveyForm extends FormBase
{
    ...
    public function buildForm(
        ...
        $form['fields']['box']['row']['message'] = [
            '#type' => 'markup',
            '#markup' =>
                '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 result-survey-message"></div>',
        ];
        ...
        $form['fields']['box']['row']['description'] = [
            ...
            '#default_value' => isset($survey['description'])
                ? $survey['description']
                : '',
            '#wrapper_attributes' => [
                'class' => 'col-xs-12 col-sm-12 col-md-12 col-lg-12',
    ...
    public function promptCallback(array &$form, FormStateInterface $form_state)
    {
        if ($form_state->hasAnyErrors()) {
            ...
            $response->addCommand(
                new HtmlCommand('.result-survey-message', $messages)
            );
        }
